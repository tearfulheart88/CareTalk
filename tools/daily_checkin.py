...
def _gpt_analyze_sentiment(message: str) -> Tuple[str, List[str], str]:
    """
...
"""
        ...
        return sentiment, health_keywords, follow_up_action
...
def analyze_checkin_response(
    ...
    if mock:
        ...
        # 실제 GPT-4o-mini 분석
        sentiment, health_keywords, follow_up_action = _gpt_analyze_sentiment(message)
